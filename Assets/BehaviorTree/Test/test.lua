...
function Test:Update()
    ...
    -- if UnityEngine.Input.GetKeyDown(UnityEngine.KeyCode.W) then
    --     local condition = bt1:FindTaskWithName("bool")
    --     condition.bVal2 = true
    -- end
    if UnityEngine.Input.GetKeyDown(UnityEngine.KeyCode.Q) then
        local boolCom3001 = bt7:FindTaskWithName("boolCom4001")
        boolCom3001.boolValue2 = true
    end
    if UnityEngine.Input.GetKeyDown(UnityEngine.KeyCode.W) then
        local boolCom3003 = bt7:FindTaskWithName("boolCom4003")
        boolCom3003.boolValue2 = true
    end
end
...
function Test:CreateBT7()
    local btree = BT.BTree.New(nil, "bt0")
    --1
    ...
    sel1001:AddChild(rep2002)

    local rep2003 = BT.Repeater:New("rep2003")
    rep2003:SetExecutionCount(300)
    sel1001:AddChild(rep2003)
    --3
    ...
    local seq3003 = BT.Sequence:New("seq3003")    
    seq3003:SetAbortType(BT.EAbortType.LowerPriority)
    rep2003:AddChild(seq3003)
    --4
    local boolCom4001 = BT.BoolComparison:New("boolCom4001", true, false)
    seq3001:AddChild(boolCom4001)

    local log4002 = BT.Log:New("log4002", "1111")
    seq3001:AddChild(log4002)

    local boolCom4003 = BT.BoolComparison:New("boolCom4003", true, false)
    seq3002:AddChild(boolCom4003)

    local log4004 = BT.Log:New("log4004", "2222")
    seq3002:AddChild(log4004)

    local log4005 = BT.Log:New("log4005", "3333")
    seq3003:AddChild(log4005)

    local wait4006 = BT.Wait:New("wait4006", 2)
    seq3003:AddChild(wait4006)
    return btree
end
...
function Test:CreateBT()
    ...
    local wait3002 = BT.Wait:New("wait3002", 2)
...
function Test:CreateBT1()
    ...
    local wait4001 = BT.Wait:New("wait4001", 2)
